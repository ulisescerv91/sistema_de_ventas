...
<br>
<div id="titulov">Ventas</div>
<center><h4>Seleccciona las fechas de busqueda</h4></center>
<form action="tablaventadia.php" method="POST">
...
<?php
	include("../conexion.php");
		...
		$extra="SELECT * FROM ventadeldia where fecha BETWEEN '$tfecha1' and '$tfecha2' ";
		...
		for ($i=0; $i < $nfiles; $i++)
		 ...
		 { 
			...
			*/
			...
			echo "<td> "."$"."$fila[totalmesa]</td>";
			echo "<td> $fila[fecha]</td>";

			$total+=$fila['totalmesa'];
